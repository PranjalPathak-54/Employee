...
const Sidebar = () => {
    ...
    return (
        <>
            ...
            {mobileopen && <div className='lg:hidden fixed inset-0 bg-black/60 backdrop-blur-sm z-40' onClick={() => setmobileopen(false)}></div>}
            <aside className='hidden lg:flex flex-col h-full w-[260px] bg-linear-to-b from-slate-900 via-slate-900 to-slate-900 text-white shrink-0 border-r border-white/4'>
                {sidebarContent}
            </aside>
