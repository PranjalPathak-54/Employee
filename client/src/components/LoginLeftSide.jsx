    ...
    return (
        <div className='hidden md:flex w-1/2 bg-indigo-950 relative overflow-hidden border-r'>
            ...
            <div className='relative z-10 flex flex-col items-start justify-center p-12 lg:p-20 w-full h-full'>
                ...
                <p className='text-slate-400 text-lg max-w-md leading-relaxed'>Streamline your Workforce operations and track your attendance manage payroll and empower your team securely.</p>
            </div>
        </div>
    )
}
