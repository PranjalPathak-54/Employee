                    ...
                    <form className='space-y-5' onSubmit={handleSubmit}>
                        ...
                        <div>
                            ...
                            <div className='relative'>
                                <input type={showpassword ? 'text' : 'password'} value={password} onChange={(e) => setpassword(e.target.value)} className='pr-11' required placeholder='.........' />
                                <button type='button' className='absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 transition-colors' onClick={() => setshowpassword(!password)}>
                                    {showpassword ? <EyeOffIcon size={18} /> : <EyeOffIcon size={18} />}
                                </button>
                            </div>
                        </div>
